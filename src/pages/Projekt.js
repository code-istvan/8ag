                ...
                <Col>
                  <Card className="taxnumber">
                    ...
                    <Card.Body>
                      ...
                      <Button variant="primary" href="http://www.nyolcag.hu/banki_utalas.pdf" target="_blank" rel="noopener noreferrer">Adatok letöltése .pdf-be</Button>
                    </Card.Body>
                  ...
                  <Card className="taxnumber">
                    ...
                    <Card.Body>
                      <Card.Text>Szeretsz postára járni? Postai befizetéssel is tudsz minket támogatni, amihez “sárga csekket” küldünk. Add meg a postacímedet, és már megy is a csekk. Az adományozásra vonatkozóan érdemes tudni, hogy készpénzzel történő csekkbefizetés kapcsán 2018. január 1-től változtak a szabályok. Az esetlegesen elkért személyes adatokat kizárólag a posta kezeli!
                        Ezen a <Link href="https://www.posta.hu/csekkbefizetes_keszpenzzel_valtozo_szabalyok_2018" target="_blank">linken</Link> tájékozódhatsz erről.</Card.Text>
                      <DevTooltipPosta />
                    </Card.Body>
                    <Card.Footer className="text-muted"><b>Köszönjük :-)</b></Card.Footer>
                  </Card>
              ...
              <Row>
                <Col>
                  <Card className="taxnumber">
                    ...
                    <Card.Body>
                      <Card.Text>Van PayPal számlád? Adakozz gondtalanul! A <Link href="https://www.paypal.com/hu/home" target="_blank">PayPal</Link> pénzügyi adataid nem osztjuk meg a címzettel. Egyszerű, biztonságos, nyomkövethető és gyors. Ez a funkció jelenleg fejlesztés alatt van, hamarosan használható lesz.</Card.Text>
                      <DevTooltipPayPal />
                    </Card.Body>
                    <Card.Footer className="text-muted"><b>Köszönjük :-)</b></Card.Footer>
                  </Card>

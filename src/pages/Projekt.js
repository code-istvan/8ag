      ...
      <Row className="justify-content-md-center">
        <Col className="justify">
          <Alert variant="primary">
            Amennyiben szeretnéd, hogy az adomány beérkezését követően a nevedet
            és az adomány összegét, vagy csak a nevedet az Alapítvány honlapján
          ...
          <Card className="taxnumber">
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                <hr /> Kérjük, hogy a közleménybe írjátok be a támogatni kívánt{" "}
                <Link href="/projektjeink">projekt</Link> nevét. Vagy ha az
                általános működésünket szeretnéd támogatni írd be a közleménybe:
                “általános”. A közlemény nélkül beérkező összegeket
                alapítványunk alaptevékenységére fordítjuk. Példa: ha a{" "}
                <Link href="/projektjeink">ONE SIMPLE THING</Link> projektet
                szeretné támogatni, a közleménybe ezt írd: “one simple thing”.
              </Card.Text>
              <Button
                variant="primary"
                href={MyPDF2}
          ...
          <Card className="taxnumber">
            ...
            <Card.Body>
              <Card.Text>
                ...
                csekkbefizetés kapcsán 2018. január 1-től változtak a szabályok.
                Az esetlegesen elkért személyes adatokat kizárólag a posta
                kezeli! Ezen a{" "}
                <Link
